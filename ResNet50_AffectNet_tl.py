...
retrain = True
cp_dir ='/home/ubuntu/Notebooks/Models/AffectNet_resnet_v1.h5'
log_dir = '/home/ubuntu/Notebooks/Models/AffectNet_resnet_v1_log_.csv'
...
#prediction
predict = best_FER_VGGFaceResnet50.predict(test_iter, steps = nb_samples, verbose=1)
